      ...
      <Box className={classes.root}>
        ...
        >
          <div className={classes.containerTitle}>
            <Typography variant="overline" className={classes.titleForm}>
          ...
          >
            <SelectHeader
              ...
              handleChange={(e: SelectChangeEvent) =>
                setIdUsuarioSeleccionado(Number(e.target.value))
              }
              label="Usuarios"
            ...
            >
              {!loadingUsuario &&
                ...
                dataUsuario.ListaUsuario.map(
                  ({ id, user, nombres, apellidos, tipo_usuario }, index) => {
                    return (
          ...
          {arrUsuarios.length > 0 && (
            ...
            >
              <div className={classes.title}>
                <Typography variant="overline">Destinatarios</Typography>
              </div>
              <Paper elevation={4} className={classes.paperListPago}>
                ...
                >
                  {arrUsuarios.map(({ id, user, tipo_usuario }, index) => {
                    return (
                      <Grid key={index} item xs={4}>
                        <Paper className={classes.itemListPago} elevation={1}>
                          <div
                            style={{
                              display: "flex",
                              flexDirection: "row",
          ...
          <div>
            <TextField
              ...
              error={touched.mensaje && isNotNilOrEmpty(errors.mensaje)}
              helperText={touched.mensaje ? errors.mensaje : undefined}
              required
            />
          </div>
...
EnvioCorreo.getLayout = function getLayout(page: React.ReactElement) {
  return (
    <>
      <NavBar />
      <AppLayout titulo="Envio de Correos">{page}</AppLayout>;
    </>
  );
};
