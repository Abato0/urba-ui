...
export const ListadoMatrizOperaciones = () => {
  ...
  const ExportExcel = () => {
    if (isNotNilOrEmpty(dataColumnsV2) && isNotNilOrEmpty(keysColumns)) {
      ...
      XLSX.utils.book_append_sheet(workBook, workSheet, "Matriz de Operacione");
            ...
            >
              <div className={classes.selectFecha}>
                <SelectFecha
                  ...
                  format="MMM yyyy"
                  value={fechaDesde}
                  handleChange={(e: MaterialUiPickersDate) => setFechaDesde(e)}
                />
              </div>
              ...
              <div className={classes.selectFecha}>
                <SelectFecha
                  ...
                  format="MMM yyyy"
                  value={fechaHasta}
                  handleChange={(e: MaterialUiPickersDate) => setFechaHasta(e)}
                />
              </div>
            </div>
            <div
...
ListadoMatrizOperaciones.getLayout = function getLayout(
  page: React.ReactElement
) {
  return (
    <div>
      <NavBar />
      <AppLayout titulo="Pagos - Matriz de Operaciones">{page}</AppLayout>;
    </div>
  );
};
