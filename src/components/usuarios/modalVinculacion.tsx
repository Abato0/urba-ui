...
const ModalVinculacionUsuario: FC<IProps> = ({ onClose, open, idUsuario }) => {
    ...
    const { data: dataGetUsuario, loading: loadingGetUsuario } =
        useGetUsuario(idUsuario)
    const {
        data: dataListarGrupo,
        loading: loadingListarGrupo,
        refetch: refetchListadoUsuarioSinGrupo,
    } = useListarGrupoFamiliarSinUsuarios()
    const { refetch: refetchUsuariosSinFamiliares } =
        useListadoUsuarioSinFamilares()
                                    ...
                                    <Grid item>
                                        ...
                                        >
                                            ...
                                            <Select
                                                ...
                                                labelId="grupo_familiar_label"
                                                name="grupo_familiar"
                                            >
                                                {dataListadoGrupoFamiliar &&
                                                    dataListadoGrupoFamiliar.map(
                                                        ({
                                                            id,
                                                            nombre_familiar,
                                                        }) => (
