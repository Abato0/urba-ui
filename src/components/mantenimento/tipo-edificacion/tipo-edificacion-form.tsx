...
export const IngresarTipoEdificacionForm: FC<IProps> = ({ tipoEdificacionObj, id }) => {
  ...
  return (
    <Box className={classes.root}>
      ...
      <Typography variant="h5"> Registro de Tipos de Edificaciones</Typography>
      <form
        action="#"
      ...
      >
        <div className={classes.contentLastTextBox}>
          <TextField
            ...
            helperText={
              touched.tipo_edificacion ? errors.tipo_edificacion : undefined
            }
            required
          />
        </div>
