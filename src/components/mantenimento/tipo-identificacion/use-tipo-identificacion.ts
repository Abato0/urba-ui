...
import { postTipoIdentificacion, listadoTipoIdentificacion, getTipoIdentificacion, updateTipoIdentificacion, deleteTipoIdentificacion } from "./tipo-identificacion-typedef";


export const usePostTipoIdentificacionMutation = () => {
  const [mutate, { data, loading, error }] = useMutation(postTipoIdentificacion, {
...
export const usePutTipoIdentificacionMutation = () => {
  const [mutate, { data, loading, error }] = useMutation(updateTipoIdentificacion, {
    // refetchQueries: [{ query: listadoParentesco }],
    notifyOnNetworkStatusChange: true,
  });
  return [mutate, data, loading, error];
...
export const useDeleteTipoIdentificacionMutation = () => {
  const [mutate, { data, loading, error }] = useMutation(deleteTipoIdentificacion, {
    // refetchQueries: [{ query: listadoParentesco }],
    notifyOnNetworkStatusChange: true,
  });
  return [mutate, data, loading, error];
