            ...
            try {
                if (isNotNilOrEmpty(statusVehiculo)) {
                    ...
                    if (isNotNilOrEmpty(data)) {
                        ...
                        if (
                            code === 200 &&
                            isNotNilOrEmpty(data.PutStatusVehiculo)
                        ) {
                            setBoolPut(true)
                            setErrorModal(false)
                        }
                ...
                setErrorModal(true)
                setMensajeModalMsj(
                    'El status no ha sido guardado: ' + error.message
                )
                setOpenModalMsj(true)
            }
        },
            ...
            >
                <div className={classes.contentLastTextBox}>
                    <TextField
                        ...
                        margin="normal"
                        error={
                            touched.statusVehiculo &&
                            isNotNilOrEmpty(errors.statusVehiculo)
                        }
                        helperText={
                            touched.statusVehiculo
                                ? errors.statusVehiculo
                                : undefined
                        }
                        required
                    />
